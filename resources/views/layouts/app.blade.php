...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('img/electricity.png') }}" type="image/x-icon" />
    ...
    <style>
        ...
        .navbar-brand {
            color: #9E4244;
            text-shadow: 2px 2px 4px #FFFF9E;
            font-weight: bold;
        }
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light" style="background-color: #ff9797; shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/electricity.png') }}" alt="Logo" width="30" height="30"
        ...
        <footer class="footer absolute-bottom py-1" style="background-color: #D3D3D3; color: black;">
            <div class="container d-flex justify-content-between align-items-center font-weight-bold">
                <span class="text-muted">Copyright © PLN 2023. All Rights Reserved.</span>
